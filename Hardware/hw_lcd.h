...
#define LCD_RES_Clr()                                                          \
  DL_GPIO_clearPins(GPIO_LCD_PORT, GPIO_LCD_PIN_RES_PIN) // RES
...
#define LCD_BLK_Clr()                                                          \
  DL_GPIO_clearPins(GPIO_LCD_PORT, GPIO_LCD_PIN_BLK_PIN) // BLK
